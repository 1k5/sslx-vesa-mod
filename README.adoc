...
a program to convert this raw form to the SUN Rasterfile image format.  The
rasterfile format is understood by, e.g., ImageMagick.  Here is the extracted
CG6 logo in PNG format:
